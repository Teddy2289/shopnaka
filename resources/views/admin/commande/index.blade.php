    ...
    <div class="card-block caption-breadcrumb">
        ...
        <div class="page-header-breadcrumb">
            <ul class="breadcrumb-title">
                ...
                <li class="breadcrumb-item"><a href="#!">{{__('Commandes')}}</a>
                </li>
                <li class="breadcrumb-item"><a href="#!">{{__('Liste commandes')}}</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <button class="btn btn-inverse"><i class="icofont icofont-ui-add"></i>Nouveau commande</button>
            </div>
        </div>
    </div>
    <div class="card">
