...
@section('content')
    ...
    <div class="card">
        <div class="card-block">
            <form id="main" method="post" action="{{route('subcategorie.update',$subcategory->id)}}" novalidate="novalidate">
                {{ csrf_field() }}
                <div class="form-group row has-error">
                    ...
                    <div class="col-sm-10">
                        <input type="text"
                               ...
                               value="{{ old('sub_name',$subcategory->sub_name)}}" name="sub_name" id="sub_name"
                               placeholder="catégorie sub_name" >
                ...
                <div class="form-group row has-error">
                    ...
                    <div class="col-sm-10">
                        <input type="number"
                               ...
                               value="{{ old('product_count',$subcategory->product_count) }}" name="product_count" id="product_count"
                               placeholder="catégorie product_count" required>
